...
const docTemplate = `{
    ...
    "info": {
        ...
        "contact": {
            "name": "API Support",
            "email": "support@reminder-server.com"
        },
        "license": {
            "name": "MIT",
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.ReminderCreateRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/reminders/{id}": {
            ...
            "patch": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Reminder update data",
                        "name": "reminder",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.ReminderUpdateRequest"
                        }
                    }
                ],
                "responses": {
